...
IMAGE_TAG="${IMAGE_TAG:-staging-multiarch-v0.3}"
...
[ -f "${BUILD_CONTEXT}/auth_server.py" ] || err "auth_server.py not found"
[ -f "${BUILD_CONTEXT}/requirements.txt" ] || err "requirements.txt not found"
